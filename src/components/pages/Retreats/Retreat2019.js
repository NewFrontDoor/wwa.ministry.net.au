...
import Karen from '../../../assets/img/Karen Fair.png'
    ...
    render() {
        ...
        return (
            <section className="container">
                ...
                <h3>LOVING GOD - LOVING OTHERS</h3><br />
                <div className="text-center mobile-only">
                    <img src={Banner} alt="" className="img img-responsive mobile-image" style={{ display: "inline-block", maxHeight: "250px" }} />
                </div>

                <div className="desktop-only">
                    <img src={Banner} alt="" className="img img-responsive" style={{ float: "right", maxHeight: "320px" }} />
                </div>
                <br />
                <p >
                ...
                <p>
                    This year we're delving into the topic Loving God, Loving Others and grappling with questions of<br /><br />
                    How does God love us?<br />
                    How do we love people in our lives?<br />
                    What is it that holds us back from loving others as God commands?<br /><br />
                </p>
                ...
                <div className="text-center mobile-only">
                    <img src={Speaker} alt="" className="img img-responsive mobile-image" style={{ display: "inline-block", maxHeight: "275px" }} />
                </div>

                <div className="desktop-only">
                    <img src={Speaker} alt="" className="img img-responsive" style={{ float: "right", maxHeight: "320px" }} />
                </div>
                <p className="speaker-bio">
                    Kathy is originally from Sydney and is the place where her adult children live and where her parish ministry and legal work was. However the last 2 years have brought many changes for Kathy when God called her and her husband Dave to move to Brisbane to work with a new ministry called <em><a href="https://church2church.org.au/" target="_blank" rel="noopener noreferrer">Church2Church</a></em>.
            <br /><br />
            ...
            <br /><br />
                ...
                <div className="electives-container">
                    <p className="electives-list">


                        <div className="desktop-only">
                            <img src={Karen} alt="" className="img img-responsive" style={{ float: "right", maxHeight: "250px" }} />
                        </div>
                        <h4><strong>Women and Work</strong> with Karen Fair</h4>
                        <div className="text-center mobile-only">
                            <img src={Karen} alt="" className="img img-responsive mobile-image" style={{ display: "inline-block", maxHeight: "275px" }} />
                        </div>
                        <p className="electives-sublist">
                            ...
                            <br />
                            <p>Karen Fair belongs to <a href="https://soulchurch.org.au" rel="noopener noreferrer" target="_blank">Soul Church</a> where she loves opening up the Bible with women and talking about life. She is married to Steve. She enjoys doing simple but slow restoration of old furniture.</p>
                        </p>
                    </p>

                    <p className="electives-list">

                        <div className="desktop-only" style={{ marginTop: "100px" }}>
                            <img src={Christine} alt="" className="img img-responsive" style={{ float: "right", maxHeight: "250px" }} />
                        </div>

                        <h4><strong>Women on Mission</strong> with Christine Jolly</h4>
                        <div className="text-center mobile-only">
                            <img src={Christine} alt="" className="img img-responsive mobile-image" style={{ display: "inline-block", maxHeight: "275px" }} />
                        </div>

                        <p className="electives-sublist">
                            <p>Women have been at the fore of bringing the good news of Jesus to his people since the resurrection. We’ll learn about key women throughout the history of the church who have put their own comfort aside to proclaim Jesus to unreached people, translating Scripture, caring for the marginalized and teaching God’s Word.</p>
                            <br />
                            <p>Moved to Tasmania 12 years ago after finding love on the internet. Christine uses her experience as a teacher and training at Bible college to inspire the next generation of missionaries at the Hobart AFES ministry, <a href="https://ufcutas.org/" target="_blank" rel="noreferrer noopener">University Fellowship of Christians</a>. Mother of 2 girls and wife to Mike, they enjoy building with Lego together.</p>
                        </p>
                    </p>
                </div>
                ...
                <h3 style={{ marginTop: "50px" }}>Relax & Recharge</h3>
                <p>
